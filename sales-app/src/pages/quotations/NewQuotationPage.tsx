    ...
    <div>
      ...
      <div className="space-y-4 px-4 pb-8 pt-4">
        ...
        <div>
          ...
          {cart.length === 0 ? (
            <EmptyState icon={<BoxIcon className="h-8 w-8 text-slate-300" />} title="No products added" message="Tap 'Add Product' to build this quotation." />
          ) : (
        ...
        >
          {submitting ? "Saving…" : "Save Quotation (Draft)"}
        </button>
      </div>
